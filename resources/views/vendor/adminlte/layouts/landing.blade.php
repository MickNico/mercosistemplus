...
<head>
    ...
    <meta name="description" content="MercoSistemPlus <?/* - {{ trans('adminlte_lang::message.landingdescription') }}*/ ?> ">
    <meta name="author" content="Sergi Tur Badenas - acacha.org">

    <meta property="og:title" content="MercoSistemPlus" />
    <meta property="og:type" content="website" />
    <meta property="og:description" content="MercoSistemPlus /> <?/*- {{ trans('adminlte_lang::message.landingdescription') }}*/ ?> "  />
   <?php /* <meta property="og:url" content="http://lala.org/" />
    ...
    <title>{{ trans('MercoSistemPlus') }}</title>
    ...
    <div id="navigation" class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><b>MercoSistemPlus</b></a>
            </div>
            <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                    <li class="active"><a href="#home" class="smoothScroll">{{ trans('adminlte_lang::message.home') }}</a></li>
                   
                   <?php /* <li><a href="#desc" class="smoothScroll">{{ trans('adminlte_lang::message.description') }}</a></li>
            ...
            <div class="container">
                <div class="row centered">
                    ...
                    <div  align='center'>
                        ...
                        <img class="img-responsive" src="{{ asset('/img/logo-merco.png') }}" >
                    </div>
                </div>
            </div> <!--/ .container -->
        </div><!--/ #headerwrap -->
    ...
    */ ?>
    <footer>
        <div id="c">
            <div class="container">
                <p>
                    <a href="www.mercosistemplus.cl"></a><b>MercoSistemPlus</b></a><strong> Copyright &copy; 2017 <? /* . {{ trans('adminlte_lang::message.descriptionpackage') }}.*/ ?>
                </p>
            </div>
        </div>
    </footer>
