...
<div class="form-group">
    ...
    <div class="col-sm-2">
     ...
     {!! Form::label('ots_hes', 'HES', array('class'=>'col-sm-1 control-label')) !!}
    <div class="col-sm-2">
    ...
    {!! Form::label('ots_des', 'Destino', array('class'=>'col-sm-1 control-label')) !!}
    <div class="col-sm-2">
    ...
    {!! Form::label('ots_cha', 'N°Chasis', array('class'=>'col-sm-1 control-label')) !!}
    <div class="col-sm-2">
    ...
    {!! Form::label('ots_nota', 'Nota', array('class'=>'col-sm-1 control-label')) !!}
    <div class="col-sm-2">
...
<br></br>
    ...
    {!! Form::label('ots_gui', 'N°Guia', array('class'=>'col-sm-1 control-label')) !!}
    <div class="col-sm-2">
    ...
    {!! Form::label('ots_val_esp', 'Valor Especial', array('class'=>'col-sm-1 control-label')) !!}
    <div class="col-sm-2">
    ...
    {!! Form::label('ots_usr', 'Usuario', array('class'=>'col-sm-1 control-label')) !!}
    <div class="col-sm-2">
